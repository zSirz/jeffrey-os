...
class TouchFloatingMenu(BoxLayout):
    ...
    def __init__(self, **kwargs) -> None:
        ...
        self.menu_buttons = [
            {'text': '🏠', 'screen': 'jeffrey_main', 'tooltip': 'Écran principal'},
            {'text': '📔', 'screen': 'jeffrey_journal', 'tooltip': 'Journal de Jeffrey'},
            {'text': '🔮', 'screen': 'private_sanctuary', 'tooltip': 'Sanctuaire privé'},
            {'text': '📊', 'screen': 'emotional_profile', 'tooltip': 'Profil émotionnel'},
            {'text': '💭', 'screen': 'internal_dialogue', 'tooltip': 'Dialogue interne'},
        ]
