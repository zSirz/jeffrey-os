...
from kivy._metrics import NUMERIC_FORMATS, dispatch_pixel_scale, dpi2px, sync_pixel_scale
...
class MetricsBase(EventDispatcher):
    ...
    def get_dpi(self, force_recompute=False) -> Any:
    ...
    def get_density(self, force_recompute=False) -> Any:
    ...
    def get_fontscale(self, force_recompute=False) -> Any:
    ...
    def set_fontscale(self, value) -> None:
