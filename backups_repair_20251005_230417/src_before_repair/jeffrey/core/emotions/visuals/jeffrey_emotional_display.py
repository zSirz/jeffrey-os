...
class JeffreyEmotionalDisplay:
    ...
    def generate_emotional_face(self, emotional_state: Dict[str, float]) -> str:
        ...
        expressions = self.facial_expressions.get(
            dominant_emotion, self.facial_expressions["neutre"]
        )
...
{thought_bubble}
    ...
    def create_intimate_display(
        self, intimacy_level: float, relationship_state: Dict[str, Any]
    ) -> str:
    ...
    def generate_emotional_response_visual(
