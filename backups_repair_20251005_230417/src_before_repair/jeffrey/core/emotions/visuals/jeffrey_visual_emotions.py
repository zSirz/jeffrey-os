...
# Intégration avec le système principal
    ...
    # Bulle de pensée
    thought_bubble = visual_system.create_thought_bubble(
        "Je me demande ce que tu fais en ce moment...", "rêveuse"
    )
    ...
    celebration = effects.create_celebration_effect(
        "💝 Joyeux anniversaire de notre rencontre! 💝", "hearts"
    )
    print(celebration)
