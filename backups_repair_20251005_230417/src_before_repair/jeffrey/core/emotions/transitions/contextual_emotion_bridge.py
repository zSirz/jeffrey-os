...
from core.emotions.dynamic_emotion_renderer import DynamicEmotionRenderer
...
from core.memoire_sensorielle import MémoireSensorielle

# Import du système de profil affectif (Sprint 13)
try:
    from core.emotions.affective_profile import AffectiveProfile, AffectiveProfileManager
...
try:
    from core.memory.souvenir import SouvenirManager
...
class ContextualEmotionBridge:
    ...
    def __init__(
        ...
        try:
            from core.emotions.emotional_memory import EmotionalMemory
