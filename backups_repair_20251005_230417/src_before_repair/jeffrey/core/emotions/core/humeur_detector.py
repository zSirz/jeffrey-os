...
from __future__ import annotations
    ...
    def __init__(self) -> None:
        ...
        self.mots_emotions: Dict[str, List[str]] = {
            "joie": [
                "heureux", "content", "ravi", "enthousiaste", "formidable", "génial", "super",
                "joyeux", "excellent", "merveilleux", "fantastique", "extraordinaire", "incroyable",
                "adorable", "magnifique", "parfait", "agréable", "chouette", "cool", "sympa",
                "j'aime", "j'adore", "je kiffe", "je suis content", "je suis heureux"
            ],
            "tristesse": [
                "triste", "fatigué", "déçu", "énervé", "stressant", "anxieux", "frustré",
                "mélancolique", "déprimé", "abattu", "morose", "soucieux", "inquiet",
                "je suis triste", "ça me rend triste", "ça me déprime", "je me sens mal",
                "je suis fatigué", "je suis épuisé", "je suis déçu"
            ],
            "colère": [
                "énervé", "fâché", "furieux", "exaspéré", "irrité", "agacé", "contrarié",
                "je suis en colère", "ça m'énerve", "ça me met en rogne", "ça m'agace",
                "je suis furieux", "je suis exaspéré", "je suis irrité"
            ],
            "peur": [
                "peur", "effrayé", "inquiet", "anxieux", "stressé", "paniqué", "terrifié",
                "je suis inquiet", "j'ai peur", "ça m'inquiète", "ça m'angoisse",
                "je suis stressé", "je suis anxieux", "je suis paniqué"
            ],
            "amour": [
                "amour", "affection", "tendresse", "adore", "chéri", "chérie", "aimer",
                "je t'aime", "je t'adore", "tu me manques", "tu me rends heureux",
                "tu me rends heureuse", "je tiens à toi", "tu es important pour moi"
            ],
            "curiosité": [
                "curieux", "intéressant", "fascinant", "intriguant", "je me demande",
                "comment ça marche", "pourquoi", "explique-moi", "raconte-moi",
                "je voudrais savoir", "je suis curieux", "je suis curieuse"
            ],
            "sérénité": [
                "calme", "paisible", "serein", "apaisé", "détendu", "zen", "tranquille",
                "je suis calme", "je me sens bien", "je suis détendu", "je suis serein",
                "je suis apaisé", "je suis zen"
            ],
            "surprise": [
                "surpris", "étonné", "stupéfait", "incroyable", "waouh", "oh",
                "je suis surpris", "je suis étonné", "je n'en reviens pas",
                "c'est incroyable", "c'est stupéfiant"
            ],
            "neutre": [
                "normal", "ok", "moyen", "rien de spécial", "comme d'habitude",
                "je ne sais pas", "peut-être", "bof", "ça va", "comme ci comme ça"
            ]
        }
    ...
    def analyser_intensite(self, texte: str) -> float:
        ...
        intensificateurs = ["très", "vraiment", "énormément", "extrêmement", "terriblement",
                          "incroyablement", "absolument", "totalement", "complètement"]
