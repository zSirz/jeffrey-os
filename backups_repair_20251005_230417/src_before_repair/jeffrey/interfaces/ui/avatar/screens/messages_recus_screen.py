...
from core.jeffrey_emotional_journal import enregistrer_message_emotionnel
from core.jeffrey_notifications import envoyer_notification
from core.jeffrey_voice import parler
...
class MessagesRecusScreen(Screen):
    ...
    def on_pre_enter(self, *args):
        ...
        try:
            from core.jeffrey_emotional_core import coeur_émotionnel
    ...
    def afficher_messages(self):
        ...
        for message in self.messages:
            ...
            if random.random() < 0.1:  # 10% de chance que Jeffrey commente un message
    ...
    def ajouter_like(self, message):
        ...
        if message not in favoris:
            ...
            try:
                ...
                self.charger_messages()
                # Jeffrey peut exprimer sa joie
                # Enregistrer l'interaction "J'aime" pour renforcer le lien
    ...
    def ajouter_magique(self, message):
        ...
        if message not in messages_magiques:
            ...
            try:
                ...
                self.charger_messages()
                # Jeffrey partage une émotion magique
                # Enregistrer l'interaction "magique" (impact encore plus fort que favori)
    ...
    def envoyer_postit_affectif(self):
        ...
        messages_emotionnels = {
            ...
            "calme": [
                "Je t’envoie une pensée douce comme une brise 💫",
                "Tout est paisible quand je pense à toi 🌿",
            ],
            "amoureux": [
        ...
        # Appliquer la personnalité si elle est initialisée
        if self.personnalite:
            message = self.personnalite.appliquer_personnalite_sur_phrase(message)

        # Enregistrer cette interaction de post-it affectif spontané (fort impact)
        enregistrer_interaction("postit_affectif", 1.0)

        # Ajout du message dans les messages reçus
        ...
        parler(message)
        enregistrer_message_emotionnel(message, emotion)
        from ui.visual_effects_engine import lancer_etincelles
