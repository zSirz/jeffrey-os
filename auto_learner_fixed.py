"""
Module d'apprentissage automatique pour améliorer les modèles IA.

Ce module fournit des capacités d'apprentissage automatique pour améliorer
les modèles IA en utilisant les interactions passées et les feedbacks utilisateurs.
"""
...
class AutoLearner:
    ...
    @secure_api_method(model_name_attr="base_model", reason="Analyse d'amélioration des connaissances")
    ...
    def retrain_from_memory(self, log_path="data/learning_log.jsonl"):
        ...
        try:
            ...
            from jeffrey.core.ia_services.export_learning import (
                export_for_training,
                load_log,
                score_entries,
            )
